<template>
  <div class="encounter">
    ...
    <div class="row tabrow">
      ...
      <!--PLAYERS TAB -->
      <div class="col-md-2">
        <button type="button" class="btn btn-default" @click="showPlayer=true"><img src="http://i44.photobucket.com/albums/f3/suhmantha/swordwoman_zps1ej7mjd4.png" alt="PLAYERS"></button>
      ...
      <!--SPELLS TAB -->
      <div class="col-md-2">
        <button type="button" class="btn btn-default" @click="showSpells=true"><img src="http://i44.photobucket.com/albums/f3/suhmantha/bolt-spell-cast_zpsi9di3iqo.png" alt="SPELLS"></button>
      ...
      <!--CONDITIONS TAB -->
      <div class="col-md-2">
        <button type="button" class="btn btn-default" @click="showConditions=true"><img src="http://i44.photobucket.com/albums/f3/suhmantha/internal-injury_zpsud0740dt.png" alt="CONDITIONS"></button>
